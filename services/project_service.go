...
type ProjectService interface {
	...
	Update(id string, data requests.CreateOrUpdateProjectRequest) (*responses.ProjectResponse, *fiber.Error)
	...
	List(options requests.GetProjectOptions) (*responses.ProjectPageResponse, *fiber.Error)
}
